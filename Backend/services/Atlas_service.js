...
initializeData() {
  const serverURL = 'https://backend-production-47be.up.railway.app';
  ...
  const gv1 = new Postagem_models(Date.now()+19, [
    '${serverURL}/public/images/hemacias/hemacia0.jpg',
    '${serverURL}/public/images/hemacias/hemacia1.jpg',
    '${serverURL}/public/images/hemacias/hemacia0.jpg'],
